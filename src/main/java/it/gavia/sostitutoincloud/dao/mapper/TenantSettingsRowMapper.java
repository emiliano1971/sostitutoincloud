...
public class TenantSettingsRowMapper implements RowMapper<TenantSettings> {
    ...
    public TenantSettings mapRow(ResultSet rs, int rowNum) throws SQLException {
        return TenantSettings.builder()
                ...
                .dataNascita(rs.getObject("data_nascita", java.time.LocalDate.class))
                .sesso(rs.getString("sesso"))
                .comuneNascita(rs.getString("comune_nascita"))
                .provinciaNascita(rs.getString("provincia_nascita"))
