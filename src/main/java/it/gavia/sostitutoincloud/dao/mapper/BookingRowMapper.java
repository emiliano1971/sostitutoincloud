...
public class BookingRowMapper implements RowMapper<Booking> {
    ...
    public Booking mapRow(ResultSet rs, int rowNum) throws SQLException {
        return Booking.builder()
                ...
                .guestBirthDate(rs.getObject("guest_birth_date", LocalDate.class))
                .guestSesso(rs.getString("guest_sesso"))
                .guestBirthPlace(rs.getString("guest_birth_place"))
                .guestBirthBelfiore(rs.getString("guest_birth_belfiore"))
